...
class Data:
    ...
    def __init__(self):
        ...
        course3 = Course("C3", "CSE325", [self._instructors[2]], 35) #For Practical or Lab periods assign students are 35 only
        ...
        self._courses = [course1, course2, course3, course4, course5, course6, course7, course8, course9]
...
class DisplayMgr:
    ...
    def print_course(self):
        availableCoursesTable = prettytable.PrettyTable(['Id', 'Course code', 'Max no. of students', 'Instructors'])
    ...
    def print_generation(self, population):
        table1 = prettytable.PrettyTable(['Schedule no.', 'Fitness', 'No. of conflicts', 'Classes [dept,class,room,instructor,meeting-time]'])
    ...
    def print_schedule_as_table(self, schedule):
        ...
        table = prettytable.PrettyTable(['Class no.', 'Dept', 'Course (number, max no. of students)', 'Room (Capacity)', 'Instructor (Id)',  'Meeting Time (Id)'])
        for i in range(0, len(classes)):
